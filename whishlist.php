...
<!-- Mirrored from warethemes.com/html/bready/whishlist.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Mar 2019 22:23:43 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="table-responsive">
          <table class="table ps-table ps-table--whishlist">
            ...
            <tbody>
              ...
              <tr>
                <td><a class="ps-product--table" href="product-detail.php"><img class="mr-15" src="images/products/3.png" alt="">The Rolling Pin</a></td>
                <td><strong>$150</strong></td>
                <td><a class="ps-product-link" href="product-detail.php">View Product</a></td>
                <td>
                  <div class="ps-remove"></div>
