...
<!-- Mirrored from warethemes.com/html/bready/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Mar 2019 22:26:31 GMT -->
<head>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="ps-profile">
      <div class="ps-profile__content"><a class="ps-profile__close" href="#"><span></span></a>
        <form class="ps-form--profile-2" action="http://warethemes.com/html/bready/do_action" method="post">
          <h3>Enter your keyword</h3>
          <div class="form-group">
            <input class="form-control" type="text" placeholder="">
            <button class="ps-btn active ps-btn--fullwidth">Search</button>
    ...
    <header class="header header--3" data-sticky="false">
      ...
      <nav class="navigation">
        <div class="ps-container"><a class="ps-logo" href="homepage-3.php"><img src="images/logo-light.png" alt=""></a>
          ...
          <div class="header__actions"><a class="ps-search-btn" href="#"><i class="ba-magnifying-glass"></i></a><a href="#" class="ps-profile-btn"><i class="ba-profile"></i></a>
      ...
      <div class="ps-container">
        <div class="row">
          <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
            <form class="ps-form--contact" action="http://warethemes.com/html/bready/do_action" method="post">
              <div class="row">
...
<!-- Mirrored from warethemes.com/html/bready/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Mar 2019 22:26:53 GMT -->
</html>