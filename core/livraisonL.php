...
function afficherLivraison ($livraison){
	...
	function ajouterLivraison($livraison){
		$sql="insert into livraison (ref,nom,prenom,mail,numtel,ville,adresse,codepostal,priorite) values (:ref,:nom,:prenom,:mail,:numtel,:ville,:adresse,:codepostal,:priorite)";
