<?php
			$info=isset($_GET['connect']);
			$info1=isset($_GET['connect1']);
			
			if($info)
			{
				session_start();
				$_SESSION['connect'] = $_GET['connect'];
			...
			if($info1)
			{
				if($_GET['connect1'] == "profil")
				{
					header("location: profil.php");
				}
				else if($_GET['connect1'] == "deconnexion")
				{
				  setcookie('nom');
				  unset($_COOKIE['nom']);
				  setcookie('prenom');
...
<!-- Mirrored from warethemes.com/html/laCave/404-page.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Mar 2019 22:20:51 GMT -->
<head>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="ps-404">
      <div class="container">
        ...
        <p>We are looking for your page … but we can’t find it</p><a class="ps-btn ps-btn--yellow" href="index-2.php">Back To Home</a>
...
<!-- Mirrored from warethemes.com/html/laCave/404-page.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Mar 2019 22:21:04 GMT -->
</html>