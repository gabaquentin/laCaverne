...
<!-- Mirrored from warethemes.com/html/bready/compare.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Mar 2019 22:23:43 GMT -->
<head>
    <meta charset="utf-8">
      ...
      <nav class="navigation">
        <div class="ps-container"><a class="ps-logo" href="homepage-3.php"><img src="images/logo-light.png" alt=""></a>
          ...
          <ul class="menu">
            ...
            <li class="current-menu-item menu-item-has-children"><a href="about.php">Pages</a><span class="sub-toggle"><i class="fa fa-angle-down"></i></span>
              <ul class="sub-menu">
        ...
        <div class="table-responsive">
          <table class="table ps-table--compare">
            <tbody>
              <tr>
                <td>Product</td>
                <td><a class="ps-product--table" href="product-detail.php"><img src="images/products/1.png" alt=""> Bread</a></td>
                <td><a class="ps-product--table" href="product-detail.php"><img src="images/products/2.png" alt=""> Bread 2</a></td>
              </tr>
              <tr>
                <td>Pricing</td>
              ...
              <tr>
                <td>Order</td>
                <td><a class="ps-btn ps-btn--yellow" href="#">Add to cart</a><a class="ps-btn--favorite ml-10" href="whishlist.php"><i class="ba-heart"></i></a></td>
                <td><a class="ps-btn ps-btn--yellow" href="#">Add to cart</a><a class="ps-btn--favorite ml-10" href="whishlist.php"><i class="ba-heart"></i></a></td>
              </tr>
            </tbody>
          </table>
